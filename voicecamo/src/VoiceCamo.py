...
class CamoCNN(nn.Module):
    def __init__(self):
        super(CamoCNN, self).__init__()
        self.conv1 = nn.Conv2d(2, 64, (5,5), padding=0)
        ...
        self.convTrans1 = nn.ConvTranspose1d(1, 64, (5,5), padding=0)
        ...
        # self.fc1 = nn.Linear(4117,8000) #line from paper
    ...
    def forward(self, input):
      ...
      out = out.shape(input.shape[0],1,512)
    #   out = out.view(out.shape[0], -1)
      ...
      out = F.leaky_relu(out)
# DIFFERENCE  THEY USE THAN IN THE CODED THAT COMES WITH THE PAPER
